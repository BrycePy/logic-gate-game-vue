...
<template>
    <div class="challenge">
        ...
        <a href="https://en.wikipedia.org/wiki/NAND_logic#:~:text=Making%20other%20gates%20by%20using%20NAND%20gates%5Bedit%5D">Link: Making other gates by using NAND gates</a>
